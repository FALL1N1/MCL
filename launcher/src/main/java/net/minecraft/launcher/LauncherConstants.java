...
public class LauncherConstants {
    ...
    public static final String URL_DOWNLOAD_BASE = ""; //Dossier site.com/launcher/
    public static final boolean useModResource = true;
    public static final String URL_DOWNLOAD_MODS = ""; // http://site.com/ressource/
    public static final String URL_RESOURCE_BASE = ""; // http://site.com/ressource/
    public static final String LIBRARY_DOWNLOAD_BASE = ""; // http://site.com/ressource/
    ...
    public static final String URL_BOOTSTRAP_DOWNLOAD = ""; //http://site.com/launcher/bootstrap.jar
