...
public class PlayerInfoPanel extends JPanel implements RefreshedProfilesListener, RefreshedVersionsListener {
    ...
    private final JButton logOutButton = new JButton("Changer de pseudo");
    ...
    public void checkState() {
        ...
        if(auth == null || !auth.isLoggedIn()) {
            ...
            welcomeText.setText("<html>Salut , player!</html>");
            logOutButton.setEnabled(true);
        }
        else {
            welcomeText.setText("<html>Salut , <b>" + auth.getSelectedProfile().getName() + "</b></html>");
            logOutButton.setEnabled(true);
        }
